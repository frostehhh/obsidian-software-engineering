...
- [[Reference Notes/Adrian Cantrill/Networking/OSI 7-Layer Model/Transport/Transmission Control Protocol]] (TCP) and [[Reference Notes/Adrian Cantrill/Networking/OSI 7-Layer Model/Transport/User Datagram Protocol]] (UDP) which both run on top of [[Reference Notes/Adrian Cantrill/Networking/OSI 7-Layer Model/Network/Internet Protocol|IP]]