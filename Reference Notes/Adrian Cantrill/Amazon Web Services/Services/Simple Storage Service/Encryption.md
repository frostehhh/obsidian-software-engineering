...
- <mark style="background: #FFF3A3A6;">AES256</mark> Encryption algorithm
 
![[Pasted image 20230521153320.png]]
- Handled by KMS. It is an AWS managed KMS key
- Aside from root key, each object has its own key generated via the KMS key. This is also a [[Reference Notes/Adrian Cantrill/Amazon Web Services/Services/Key Management Service/Basics#Data Encryption Keys (DEKs)|DEK]]. Root key encrypts unique key

![[Pasted image 20230521153400.png]]
