...
runtime is responsible for code execution. Node is used to execute JS outside of a browser environment
...
> [!NOTE] What is a stream?
> It is used for handling datasets split into segments
