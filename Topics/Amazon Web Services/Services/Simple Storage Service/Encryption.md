...
- Aside from root key, each object has its own key generated via the KMS key. This is also a [[Topics/Amazon Web Services/Services/Key Management Service/Basics#Data Encryption Keys (DEKs)|DEK]]. Root key encrypts unique key
